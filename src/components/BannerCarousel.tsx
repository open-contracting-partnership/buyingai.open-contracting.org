  ...
  return (
    <div className="flex-1 relative h-[460px] flex items-center">
      {structure.sections.map((section, idx) => {
        ...
        const shouldExpand =
          hoveredSection !== null ? isHovered : isCurrentSection;
          ...
          >
            {shouldExpand ? (
              ...
              <div className="p-8 h-full flex flex-col justify-between">
                <div>
                  <div className="text-5xl font-bold text-black font-gteesti-display">
                    {section.number.toString().padStart(2, "0")}
                  </div>
                  <h3 className="my-2 text-2xl font-medium text-black font-gteesti-pro-display">
                    {section.title}
                  </h3>
